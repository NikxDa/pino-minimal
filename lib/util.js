...
const parseLine = line => {
    try {
        ...
        // Format every item
        const timestamp = formatTimestamp (lineData);
...
/**
 * Takes line data as an input and returns a formatted and colored timestamp.
...
const formatTimestamp = ({ time }) => {
    ...
    // Prepare the formats
    const timeFragment = !process.argv.minimal ? "HH:mm:ss" : "";
    const dateFragment = (process.argv.date && !process.argv.minimal) ? "yyyy.MM.dd" : "";
